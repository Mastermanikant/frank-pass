...
(function () {
    ...
    function selectCountry(country) {
        ...
        // Update top flag badge
        if (flagBadge) {
            flagBadge.innerHTML = `<img src="${getFlagUrl(country.code)}" alt="${country.code.toUpperCase()}" style="width:22px;height:auto;border-radius:2px;vertical-align:middle;" onerror="this.style.display='none'">`;
        }
    ...
    function init() {
        ...
        if (initCountry) {
            ...
            // Sync flag badge on logo
            if (flagBadge) {
                flagBadge.innerHTML = `<img src="${getFlagUrl(initCountry.code)}" alt="${initCountry.code.toUpperCase()}" style="width:22px;height:auto;border-radius:2px;vertical-align:middle;" onerror="this.style.display='none'">`;
            }
