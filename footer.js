...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if(footerBottoms && footerBottoms.length > 0) {
        footerBottoms.forEach(fb => {
             ...
             versionLabel.innerHTML = "Current Version: <span style='color: var(--accent-primary); font-weight: bold;'>2.2.1 (Stable)</span> &mdash; Evolutionary Milestone";
             fb.prepend(versionLabel);

             // GitHub Audit Link
             const githubAudit = document.createElement('p');
             githubAudit.style.fontSize = '0.85rem';
             githubAudit.style.marginBottom = '0.5rem';
             githubAudit.innerHTML = "🛡️ Audited Open Source: <a href='https://github.com/MasterManikant/frank-pass' target='_blank' style='color: var(--accent-primary); text-decoration: underline;'>View on GitHub</a>";
             fb.prepend(githubAudit);
